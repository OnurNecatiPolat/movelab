...
const PAGE_ITEMS = [
  ...
  {id: "studio", label: "Oyunlar", icon: Layers3},
  {id: "coach", label: "Koç", icon: BookOpen},
  {id: "billing", label: "Bağış", icon: CreditCard},
    ...
    <div className="app-bg">
      ...
      <aside className={cx("sidebar", sidebarOpen && "open")}>
        ...
        <Card cls="card-pad sidebar-cta">
          ...
          <strong>Review · Koç · Oyunlar · Bağış · Ayarlar</strong>
          <p className="small">Ana ürün omurgası korunuyor; sade review akışı üstüne profesyonel koç katmanı ekleniyor.</p>
        </Card>
      </aside>
      ...
      <main className="main">
        <header className="header">
          <div className="header-left">
            ...
            <div>
              <div className="small">Kişisel satranç analiz çalışma alanı</div>
...
function CoachPage({coachSummary, platformStats, busy, syncNewAndAnalyze, analyzeAllGames, setPage}) {
  return (
    <div className="page-grid coach-page">
      <Card cls="card-pad section-header coach-header-card">
        <div className="eyebrow">Profesyonel koç</div>
        <h1 className="title">Kısa, net ve çalışılabilir gelişim planı</h1>
        <p className="hero-copy">
          Burada amaç seni motor satırlarına boğmak değil; hangi alışkanlığın puanı en hızlı getireceğini sakin ve uygulanabilir şekilde göstermek.
        </p>
        <div className="hero-actions compact-actions">
          <Button cls="btn-emerald" disabled={busy} onClick={syncNewAndAnalyze} title="Sadece yeni oyunları ekle ve derin analiz et">
            <WandSparkles size={16} />
            Yeni oyunları çek + analiz et
          </Button>
          <Button cls="btn-violet" disabled={busy} onClick={analyzeAllGames} title="Tüm oyunları parça parça derin analiz et">
            <LineChart size={16} />
            Tüm oyunları derin analiz et
          </Button>
          <Button cls="btn-white" onClick={() => setPage("studio")} title="Oyun import ekranına geç">
            <Database size={16} />
            Oyunlara git
          </Button>
        </div>
      ...
      {coachSummary ? (
        <CoachSummaryPanel summary={coachSummary} />
      ) : (
        <Card cls="card-pad coach-summary-card">
          <div className="eyebrow">Henüz yeterli veri yok</div>
          <h2>Önce birkaç oyunu içe aktaralım.</h2>
          <p className="coach-note-text">
            Yeni oyunları çekip derin analiz çalıştırınca sana win/lose oranı, tekrar eden hata teması ve kısa çalışma planı çıkaracağım.
          </p>
        </Card>
      )}

      <div className="coach-principles">
        <Card cls="card-pad principle-card"><strong>1. Önce güvenlik</strong><p className="small">Her hamlede 10 saniye: şah çekme, alma, tehdit.</p></Card>
        <Card cls="card-pad principle-card"><strong>2. Tek ana ders</strong><p className="small">Her oyundan bir hata ve bir iyi karar seç. Fazlası gürültü üretir.</p></Card>
        <Card cls="card-pad principle-card"><strong>3. Aday hamle refleksi</strong><p className="small">İlk iyi hamleyi hemen oynama; iki aday daha çıkar.</p></Card>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="page-grid">
      <Card cls="card-pad section-header">
        <div className="eyebrow">Oyunlar</div>
        ...
        <Card cls="card-pad">
          <div className="split-head">
            <div>
              ...
              <strong>Chess.com yeni oyun senkronizasyonu</strong>
            </div>
            <Import size={18} />
          </div>
